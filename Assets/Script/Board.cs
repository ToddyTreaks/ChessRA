        ...
        private Piece CreatePiece(int line, int col, Team team, Position pos)
        {
            switch (line)
            {
                case 0: case 7:
                    switch (col)
                    {
                        case 0: case 7: return new Rock(pos, team);
                        case 1: case 6: return new Knight(pos, team);
                        case 2: case 5: return new Bishop(pos, team);
                        case 3:         return new Queen(pos, team);
                        case 4:         return new King(pos, team);
                    }
                    break;
                case 1: case 6:         return new Pawn(pos, team);
            }
            return null;
        }
